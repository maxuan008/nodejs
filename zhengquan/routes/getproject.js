   		   ...
   		   async_user.eachSeries(docuser, function(uservalue,callback){
   			   ...
   			   User.UserFindOne_X(1, uservalue.projid , uservalue.userid , function(err,userresult){
   				 User.usermodule(uservalue.projid , uservalue.userid,function(err,modresult) {
   				   ...
   				   resul=  resul+  "<div  class=\'" + usersclass + "\' >" + upn  +"."  +  userresult.name     + "(" +  modresult  + ") "+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <a href=\'http://localhost:3008/updateUserModule?sid="+ userresult._id +  "&prjid="+ uservalue.projid+"\'>更改</a>  &nbsp; &nbsp;  <a onclick=\'cancelusers(" + userresult.userid + ", "+ uservalue.projid + " )\'  > -注销 </a> </div>";
